...
#Intialize chat history database
...
def process_website(website_url):
    ...
    if existing_collection:
        ...
        st.session_state.success_messages.append("New Website detected. Started processing...")
        
        # Clear any existing scraped data 
        clear_scraped_data(SCRAPED_DIR)

        # Crawl website URLs
        with st.spinner("Crawling website URLs..."):
...
def main():
    ...
    # Ensure data directiories exist
